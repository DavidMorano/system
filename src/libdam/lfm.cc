...
static int	lfm_lockload(LFM *,lfm_ch *) ;
static int	lfm_locklost(LFM *,lfm_ch *,FILER *) ;
...
static int lfm_lockload(LFM *op,lfm_ch *lcp)
{
	int		rs = SR_OK ;
	int		rs1 ;
...
static int lfm_locklost(LFM *op,lfm_ch *lcp,FILER *fp)
{
	STOREITEM	cb ;

...
extern int sesmsg_exit(struct sesmsg_exit *,int,char *,int) noex ;
extern int sesmsg_noop(struct sesmsg_noop *,int,char *,int) noex ;
extern int sesmsg_gen(struct sesmsg_gen *,int,char *,int) noex ;
extern int sesmsg_biff(struct sesmsg_biff *,int,char *,int) noex ;
extern int sesmsg_echo(struct sesmsg_echo *,int,char *,int) noex ;
extern int sesmsg_response(struct sesmsg_response *,int,char *,int) noex ;
extern int sesmsg_passfd(struct sesmsg_passfd *,int,char *,int) noex ;
extern int sesmsg_getsysmisc(struct sesmsg_getsysmisc *,int,char *,int) noex ;
extern int sesmsg_sysmisc(struct sesmsg_sysmisc *,int,char *,int) noex ;
extern int sesmsg_getloadave(struct sesmsg_getloadave *,int,char *,int) noex ;
extern int sesmsg_sysmisc(struct sesmsg_sysmisc *,int,char *,int) noex ;
extern int sesmsg_reploadave(struct sesmsg_reploadave *,int,char *,int) noex ;
extern int sesmsg_loadave(struct sesmsg_loadave *,int,char *,int) noex ;
extern int sesmsg_getlistener(struct sesmsg_getlistener *,int,char *,int) noex ;
extern int sesmsg_listener(struct sesmsg_listener *,int,char *,int) noex ;
extern int sesmsg_mark(struct sesmsg_mark *,int,char *,int) noex ;
extern int sesmsg_unknown(struct sesmsg_unknown *,int,char *,int) noex ;
extern int sesmsg_gethelp(struct sesmsg_gethelp *,int,char *,int) noex ;
extern int sesmsg_help(struct sesmsg_help *,int,char *,int) noex ;
extern int sesmsg_cmd(struct sesmsg_cmd *,int,char *,int) noex ;

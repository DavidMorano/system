...
local int lineindex_dtor(lineindex *op) noex {
	int		rs = SR_FAULT ;
	if (op) ylikely {
	    rs = SR_OK ;
	    if (op->sbp) ylikely {
...
local int	lineindex_stbegin(LI *,cc *,cc *) noex ;
local int	lineindex_stend(LI *) noex ;
local int	lineindex_opener(LI *) noex ;

local int	lineindex_idxmbegin(LI *,time_t) noex ;
local int	lineindex_idxmend(LI *) noex ;
local int	lineindex_idxmap(LI *,time_t) noex ;

local int	lineindex_idxopen(LI *,time_t) noex ;
local int	lineindex_idxopener(LI *) noex ;
local int	lineindex_idxclose(LI *) noex ;
local int	lineindex_idxverify(LI *) noex ;

...
/* initialize a cursor */
int mailalias_curbegin(MA *op,MA_CUR *curp)
{
...
/* free up a cursor */
int mailalias_curend(MA *op,MA_CUR *curp)
{
	const time_t	dt = time(NULL) ;
	int		rs = SR_OK ;
...
#ifdef	COMMENT
/* get information */
int mailalias_info(MA *op,MAILALIAS_INFO *rp)
{
	int		rs = SR_OK ;
...
/* do some checking */
int mailalias_check(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		f = FALSE ;
...
static int mailalias_checkchanged(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		f = FALSE ;
...
/* is the file old? */
static int mailalias_checkold(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		f = FALSE ;
...
static int mailalias_hdrload(MA *op)
{
...
static int mailalias_hdrloader(MA *op)
{
...
static int mailalias_fileopen(MA *op,time_t dt)
{
	int		rs = SR_OK ;
...
static int mailalias_fileclose(MA *op)
{
	int		rs = SR_OK ;
	int		rs1 ;
	if (op->fd >= 0) {
...
static int mailalias_mapbegin(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		f = FALSE ;
	if (op->mapdata == NULL) {
...
static int mailalias_mapend(MA *op)
{
	int		rs = SR_OK ;
	int		rs1 ;
	if (op->mapdata != NULL) {
...
static int mailalias_keymatch(MA *op,int opts,int ri,cchar *aname)
{
	int		ki ;
	int		f ;
...
static int mailalias_dbopen(MA *op,time_t dt)
{
	int		rs ;
	int		f_create = FALSE ;
...
static int mailalias_dbopenfile(MA *op,time_t dt)
{
	int		rs ;
	int		of = op->oflags ;
	int		f_create = FALSE ;
...
static int mailalias_dbopenmake(MA *op,time_t dt)
{
	int		rs = SR_OK ;
...
static int mailalias_dbopenwait(MA *op)
{
	USTAT		sb ;
...
static int mailalias_isremote(MA *op)
{
	int		rs ;
...
static int mailalias_dbclose(MA *op)
{
	int		rs = SR_OK ;
	int		rs1 ;
...
/* make the index file */
static int mailalias_dbmake(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		cl ;
	const char	*cp ;
...
static int mailalias_dbmaker(MA *op,time_t dt,cchar *dname)
{
...
static int mailalias_dbmaking(MA *op,int fd,time_t dt,int n)
{
...
static int mailalias_procfile(MA *op,DBMAKE *dp,cchar *fname)
{
	bfile		afile ;
	int		rs ;
	int		rs1 ;
...
static int mailalias_wrfile(MA *op,DBMAKE *dp,time_t dt)
{
	int		rs ;
...
static int mailalias_wrfiler(MA *op,DBMAKE *dp,time_t dt)
{
	int		rs ;
...
/* write the key-table */
static int mailalias_wrfilekeytab(MA *op,DBMAKE *dp)
{
...
static int mailalias_wrfilerec(MA *op,DBMAKE *dp)
{
...
static int mailalias_wrfilekeys(MA *op,DBMAKE *dp)
{
...
static int mailalias_wrfilevals(MA *op,DBMAKE *dp)
{
...
static int mailalias_filechanged(MA *op,USTAT *sbp)
{
	int		f = FALSE ;
...
static int mailalias_fileold(MA *op,time_t dt)
{
	int		rs ;
	int		rs1 ;
	int		f = FALSE ;
...
/* get apfiles */
static int mailalias_aprofile(MA *op,time_t dt)
{
	struct ustat	sb ;
	kvsfile		aptab ;
...
static int mailalias_enterbegin(MA *op,time_t dt)
{
	int		rs ;
	int		f = FALSE ;
...
/* ARGSUSED */
static int mailalias_enterend(MA *op,time_t dt)
{
	int		rs = SR_OK ;
...
static int mailalias_mapcheck(MA *op,time_t dt)
{
	int		rs = SR_OK ;
	int		rs1 ;
	int		f = FALSE ;

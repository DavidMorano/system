...
#ifndef	BIBDBKEYVAL_INCLUDE
#define	BIBDBKEYVAL_INCLUDE
#ifdef	__cplusplus
...
namespace bibdbx {
    extern int	keyval_start	(keyval *) noex ;
    extern int	keyval_size	(keyval *) noex ;
    extern int	keyval_finish	(keyval *) noex ;
} /* end namespace (bibdbx) */
 

#endif /* __cplusplus */
#endif /* BIBDBKEYVAL_INCLUDE */

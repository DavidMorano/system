...
#ifndef	BIBDBREADENT_INCLUDE
#define	BIBDBREADENT_INCLUDE
#ifdef	__cplusplus
...
namespace bibdbx {
   extern int bibdb_readent(bibdb *,bibdb_ent *,char *,int,bibdb_key *) noex ;
} /* end namespace (bibdbx) */


#endif /* __cplusplus */
#endif /* BIBDBREADENT_INCLUDE */

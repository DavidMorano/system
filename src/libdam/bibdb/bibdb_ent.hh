...
#ifndef	BIBDBENT_INCLUDE
#define	BIBDBENT_INCLUDE
#ifdef	__cplusplus
...
#include	"bibdb_bibentry.hh"	/* |bibentry| */
#include	"bibdb.h"		/* |bibdb_ent| */


namespace bibdbx {
   extern int	entry_load(bibdb_ent *,char *,int,bibentry *) noex ;
} /* end namespace (bibdbx) */


#endif /* __cplusplus */
#endif /* BIBDBENT_INCLUDE */

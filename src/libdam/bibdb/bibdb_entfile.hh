...
#ifndef	BIBDBENTFILE_INCLUDE
#define	BIBDBENTFILE_INCLUDE
#ifdef	__cplusplus
...
struct bibdb_entfile {
	cchar		*fname ;
	int		f_indexed ;
} ; /* end struct (bibdb_entfile) */

namespace bibdbx {
    extern int bibdbentfile_start	(bibdb_entfile *,cchar *) noex ;
    extern int bibdbentfile_finish	(bibdb_entfile *) noex ;
    extern int bibdbentfile_indexed	(bibdb_entfile *) noex ;
} /* end namespace (bibdbx) */


#endif /* __cplusplus */
#endif /* BIBDBENTFILE_INCLUDE */

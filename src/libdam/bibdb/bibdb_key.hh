...
#ifndef	BIBDBKEY_INCLUDE
#define	BIBDBKEY_INCLUDE
#ifdef	__cplusplus
...
struct bibdb_key {
	...
	int		clen ;
	int		fi ;		/* file index */
} ; /* end struct (bibdb_key) */

namespace bibdbx {
   extern int bibdbkey_start	(bibdb_key *,int,uint,cchar *,int) noex ;
   extern int bibdbkey_finish	(bibdb_key *) noex ;
} /* end namespace (bibdbx) */


#endif /* __cplusplus */
#endif /* BIBDBKEY_INCLUDE */

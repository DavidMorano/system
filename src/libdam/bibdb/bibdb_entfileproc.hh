...
#ifndef	BIBDBENTFILEPROC_INCLUDE
#define	BIBDBENTFILEPROC_INCLUDE
#ifdef	__cplusplus
...
namespace bibdbx {
   extern int bibdb_entfileproc(bibdb *,int,bibdb_entfile *) noex ;
} /* end namespace (bibdbx) */


#endif /* __cplusplus */
#endif /* BIBDBENTFILEPROC_INCLUDE */

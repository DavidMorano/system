...
struct keyopt : keyopt_head {
	...
	int curenumkeys	(keyopt_cur *,cchar **) noex ;
	int fetch	(cchar *,keyopt_cur *,cchar **) noex ;
	int curenumvals	(cchar *,keyopt_cur *,cchar **) noex ;
...
extern int keyopt_curenumkeys	(keyopt *,keyopt_cur *,cchar **) noex ;
extern int keyopt_fetch		(keyopt *,cchar *,keyopt_cur *,cchar **) noex ;
extern int keyopt_curenumvals	(keyopt *,cchar *,keyopt_cur *,cchar **) noex ;

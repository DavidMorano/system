...
/*******************************************************************************
	...
	Synopsis:
	int matbasestr(cchar *const *a,cchar *sp,int sl) noex
	...
	Synopsis:
	int matcasestr(cchar **a,cchar *sp,int sl) noex
...
int matxstr(cchar *const *a,cchar *sp,int sl) noex {
	cint		lch = toxc(sp[0]) ;
	int		i ;
	int		m ;
	if (sl >= 0) {
...
int matfoldstr(cchar *const *a,cchar *sp,int sl) noex {

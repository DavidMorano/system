...
/*******************************************************************************
	...
	Description:
	This subroutine scans the message for whatever.  This
	subroutine creates the brief synopsis of the message, giving:
	number, sender, subject, date, length.  We currently assume
	that the line is formatted into 80 characters (scanlong)
	or 50 characters (scanshort).

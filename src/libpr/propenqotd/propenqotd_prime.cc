...
/*******************************************************************************
	...
	Synopsis:
	int prmaintqotd(cchar *pr,int mjd,int of,int to) noex
...
local int	subinfo_start(SI *,time_t,cchar *,int,int,int) noex ;
local int	subinfo_finish(SI *) noex ;
local int	subinfo_confbegin(SI *) noex ;
local int	subinfo_confend(SI *) noex ;
local int	subinfo_setentry(SI *,cchar **,cchar *,int) noex ;
local int	subinfo_envbegin(SI *) noex ;
local int	subinfo_envend(SI *) noex ;
local int	subinfo_logfile(SI *,cchar *,int) noex ;
local int	subinfo_hostname(SI *,cchar *,int) noex ;
local int	subinfo_source(SI *,cchar *,int) noex ;
local int	subinfo_logbegin(SI *) noex ;
local int	subinfo_logend(SI *) noex ;
local int	subinfo_logenv(SI *) noex ;
local int	subinfo_defaults(SI *) noex ;
local int	subinfo_spooldir(SI *,cchar *,int) noex ;
local int	subinfo_spoolcheck(SI *) noex ;
local int	subinfo_qdirname(SI *,int) noex ;
local int	subinfo_gather(SI *,cchar *,mode_t) noex ;
local int	subinfo_opensource(SI *,cchar *,cchar *) noex ;
local int	subinfo_opensourceprog(SI *,cchar *,cchar *) noex ;

local int subinfo_defprog(SI *,cchar *) noex ;
local int subinfo_defproger(SI *,vecstr *,cchar *,cchar *) noex ;
local int subinfo_addourpath(SI *,vecstr *) noex ;
local int subinfo_addprbins(SI *,vecstr *) noex ;
local int subinfo_addprbin(SI *,vecstr *,cchar *,cchar *) noex ;
local int subinfo_id(SI *) noex ;
local int subinfo_dircheck(SI *,cchar *) noex ;
local int subinfo_dirminmode(SI *,cchar *,mode_t) noex ;

local int	config_start(struct config *,SI *,cchar *) noex ;
...
local int	setfname(SI *,char *,cchar *,int,
...
local int subinfo_start(SI *sip,time_t dt,cchar *pr,
...
local int config_start(CONFIG *csp,SI *sip,cchar *cfname) noex {
	int		rs ;
...
local int setfname(SI *sip,char *fname,cc *ebuf,int el,int f_def,

...
This is the SECDB implementation from Illumos.

This is part of the NSL (Netowrk-Socket-Layer) library implementation
from Illumos.  This is from the Name-Server-Switch sub-facility of
the Illumos LIBNSL implementation. The code used from Illumos has
not been used precisely directly, but rather has been repackaged

...
extern int	progfile(PI *,cchar *,int,int) noex ;
...
int main(int argc,con mainv argv,con mainv envv) {
	...
	if ((cp = getourenv(envv,VA-D-BUGFNAME)) != nullptr) {
	    rs = debugopen(cp) ;
...
/* help file */
	...
	if (f_help)
	    printhelp(nullptr,pip->pr,pip->searchname,pip->helpfname) ;

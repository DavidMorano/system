...
static int sesmsg_nbuf(SESMSG_MBUF *,int,int,char *,int) ;
...
int sesmsg_gen(SESMSG_GEN *sp,int f,char *mbuf,int mlen)
{
	...
	return sesmsg_nbuf(mp,mt,f,mbuf,mlen) ;
}
...
static int sesmsg_nbuf(sp,mt,f,mbuf,mlen)
SESMSG_MBUF	*sp ;
int		mt ;
int		f ;
char		mbuf[] ;

...
extern int	sfsub(cchar *,int,cchar **) ;
extern int	nextfield(cchar *,int,cchar **) ;
extern int	sicite(cchar *,int,cchar *,int) ;
extern int	silbrace(cchar *,int) ;
...
#ifdef	COMMENT
local int mbdescape(PI *,struct mbdinfo *,uint,cchar *,int) ;
#endif
...
int progscan(PI *pip,PARAMOPT *app,TAGTRACK *ttp,int fi,cchar *fname)
{
	SI		pc ;

/* music_main SUPPORT (music tones) */
/* charset=ISO8859-1 */
/* exported variables */
...
local int findratio(ratio *,int,double,double) ;
...
int main(int argc,mainv argv,mainv envv) {
    	prognamevar	progname(argc,argc,envv) ;
	ratio	r ;
...
local int findratio(rp,numlimit,basefreq,reffreq)
ratio	*rp ;
int		numlimit ;

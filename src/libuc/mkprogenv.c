...
/*******************************************************************************
	...
	Synopsis:
	int mkprogenv_start(MKPROGENV *op,cchar	**envv) noex
	...
	value. Something along these lines of using the system call
	|uc_confsys()| to grab the CS_PATH value, which in some
	systems caches a default path (the CS_PATH) valiable.
...
static int mkprogenv_mkenv(MKPROGENV *op,cchar **envv) noex {

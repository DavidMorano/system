...
/*******************************************************************************
	...
	by this subroutine here).  If the databases has any sort
	...
	[update 2018-10-03] Linux from Oracle (and maybe others)
	can live patch a completely running kernel on the fly along
	w/ its various system (shared-object) libraries.
...
int uc_getprojdef(PROJECT *pjp,char *rbuf,int rlen,cchar *name) noex {
	int		rs = SR_FAULT ;

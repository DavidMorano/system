...
constexpr zdata		zones[] = {
	...
	{ "idle", -720, 0 },	/* International Date Line, East */
	{ "idlw", 720, 0 },	/* International Date Line, West */
	{ "idt", -180, 1 },	/* Israel DT */
	{ "ist", -120, 0 },	/* Israel */
	...
	{ "sadt", -630, 1 },	/* South Australian DT */
	{ "sast", -570, 0 },	/* South Australian ST */
...
int zdb_nameoff(zdb *op,cchar *sp,int µsl,int zoff) noex {
	int		rs = SR_FAULT ;

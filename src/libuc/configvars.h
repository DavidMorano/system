...
struct configvars_head {
	vecitem		*fesp ;		/* file entries */
	vecitem		*defp ;		/* collapsed defined variables */
	vecitem		*unvp ;		/* unset ENV variables */
	vecitem		*expp ;		/* collapsed environment variables */
	vecitem		*setp ;		/* "set" variables */
	vecitem		*varp ;		/* the user variables */
	time_t		checktime ;

...
consteval void bufsizer::mknames() noex {
	...
	n[bufsize_nn]		= "NN" ;	/* node-name */
	n[bufsize_hn]		= "HN" ;	/* host-name */
	n[bufsize_un]		= "UN" ;	/* user-name */
	n[bufsize_gn]		= "GN" ;	/* group-name */
	n[bufsize_pn]		= "PN" ;	/* project-name */
	n[bufsize_pw]		= "PW" ;	/* entry-passwd */
	n[bufsize_sp]		= "SP" ;	/* entry-shadow */
	n[bufsize_ua]		= "UA" ;	/* entry-userattr */
	n[bufsize_gr]		= "GR" ;	/* entry-group */
	n[bufsize_pj]		= "PJ" ;	/* entry-project */
	n[bufsize_pr]		= "PR" ;	/* entry-protocol */
	n[bufsize_nw]		= "NW" ;	/* entry-network */
	n[bufsize_ho]		= "HO" ;	/* entry-host */
	n[bufsize_sv]		= "SV" ;	/* entry-servicet */

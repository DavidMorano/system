...
int uctimeout::cmdtimeout(int cmd,TIMEOUT *valp) noex {
	...
	return (rs >= 0) ? id : rs ;
} /* end method (uctimeout::cmdtimeout) */
...
int uctimeout::cmdcancel(TIMEOUT *valp) noex {
	...
	return rs ;
} /* end method (uctimeout_cmdcancel) */
...
int uctimeout::workready() noex {
	...
	return rs ;
} /* end method (uctimeout::workready) */
...
int uctimeout::workbegin() noex {
	...
	return rs ;
} /* end method (uctimeout::workbegin) */
...
int uctimeout::priqbegin() noex {
	...
	return rs ;
} /* end method (uctimeout::priqbegin) */
...
int uctimeout::thrsbegin() noex {
	...
	return rs ;
} /* end method (uctimeout::thrsbegin) */
...
int uctimeout::sigerbegin() noex {
	...
	return (rs >= 0) ? f : rs ;
} /* end method (uctimeout_sigerbegin) */
...
int uctimeout::sigerworker() noex {
	...
	fexitsiger = true ;
	return rs ;
} /* end method (uctimeout::sigerworker) */
...
int uctimeout::sigerwait() noex {
	...
	return (rs >= 0) ? cmd : rs ;
} /* end method (uctimeout::sigerwait) */
...
int uctimeout::sigerdump() noex {
        ...
        if ((rs >= 0) && (rs1 != SR_NOTFOUND)) rs = rs1 ;
        return rs ;
} /* end method (uctimeout::sigerdump) */
...
int uctimeout::dispbegin() noex {
	...
	return (rs >= 0) ? f : rs ;
} /* end method (uctimeout::dispbegin) */
...
int uctimeout::dispworker() noex {
	...
	fexitdisp = true ;
	return rs ;
} /* end method (uctimeout::dispworker) */
...
int uctimeout::disprecv() noex {
	...
	return (rs >= 0) ? cmd : rs ;
} /* end method (uctimeout::disprecv) */

int uctimeout::disphandle() noex {
	int		rs = SR_OK ;
	int		rs1 ;
	for (TIMEOUT *tep ; (rs1 = ciq_rem(&pass,&tep)) >= 0 ; ) {
	    if ((rs = dispjobdel(tep)) > 0) {
		{
	            timeout_f	met = (timeout_f) tep->metf ;
	            rs1 = (*met)(tep->objp,tep->tag,tep->arg) ;
		    if (rs >= 0) rs = rs1 ;
		}
		{
	            rs1 = libmem.free(tep) ;
	...
	return rs ;
} /* end method (uctimeout::disphandle) */
...
int uctimeout::dispjobdel(TIMEOUT *tep) noex {
	...
	return (rs >= 0) ? f : rs ;
} /* end method (uctimeout::dispjobdel) */

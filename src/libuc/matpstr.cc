...
/*******************************************************************************
	...
	Synopsis:
	int matpxstr(cchar *const *a,int n,cchar *sp,int sl) noex
...
typedef int (*matxstr_f)(cchar *const *,cchar *,int) noex ;
...
int matpbasestr(cchar *const *a,int n,cchar *sp,int sl) noex {
	mater	mo(tobc,nleadbasestr,matbasestr) ;
	return mo.matpxstr(a,n,sp,sl) ;
}

int matpcasestr(cchar *const *a,int n,cchar *sp,int sl) noex {
	mater	mo(touc,nleadcasestr,matcasestr) ;
	return mo.matpxstr(a,n,sp,sl) ;
}

int matpfoldstr(cchar *const *a,int n,cchar *sp,int sl) noex {
...
int mater::matpxstr(cchar *const *a,int n,cchar *sp,int sl) noex {
	int		si = -1 ;

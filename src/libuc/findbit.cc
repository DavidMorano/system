...
template<integral T> int ffbsx(T uv) noex {
	int		bn = -1 ;
	if (uv) {
	    bn = countr_zero(uv) ;
	}
...
template<integral T> int ffbcx(T uv) noex {
    	T		allones = (~ T(0)) ;
	int		bn = -1 ;
	if (uv != allones) {
	    bn = countr_one(uv) ;
...
template<integral T> int flbsx(T uv) noex {
...
template<integral T> int flbcx(T uv) noex {
    	T		allones = (~ T(0)) ;
	int		bn = -1 ; /* return-value */
	if (uv != allones) {
	    cint nbit = (szof(T) * CHAR_BIT) ;
...
int ffbsi(uint uv) noex {
	return ffbsx(uv) ;
}

int ffbsl(ulong uv) noex {
	return ffbsx(uv) ;
}

int ffbsll(ulonglong uv) noex {
	return ffbsx(uv) ;
}

int ffbci(uint uv) noex {
	return ffbcx(uv) ;
}
/* end subroutine (ffbci) */

int ffbcl(ulong uv) noex {
	return ffbcx(uv) ;
}
/* end subroutine (ffbcl) */

int ffbcll(ulonglong uv) noex {
	return ffbcx(uv) ;
}
/* end subroutine (ffbcll) */

int flbsi(uint uv) noex {
	return flbs(uv) ;
}

int flbsl(ulong uv) noex {
	return flbs(uv) ;
}

int flbsll(ulonglong uv) noex {
	return flbs(uv) ;
}

int flbci(uint uv) noex {
	return flbcx(uv) ;
}
/* end subroutine (flbci) */

int flbcl(ulong uv) noex {
	return flbcx(uv) ;
}
/* end subroutine (flbcl) */

int flbcll(ulonglong uv) noex {
	return flbcx(uv) ;
}
/* end subroutine (flbcll) */

int fbscounti(uint uv) noex {
    	return popcount(uv) ;
}
/* end subroutine (fbscounti) */

int fbscountl(ulong uv) noex {
    	return popcount(uv) ;
}
/* end subroutine (fbscountl) */

int fbscountll(ulonglong uv) noex {
    	return popcount(uv) ;
}

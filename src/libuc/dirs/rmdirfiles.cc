...
local int	vecstr_load(vecstr *,cchar *,cchar *,int) noex ;
local int	vecstr_dirsdel(vecstr *) noex ;
local bool	premat(cchar *,int,cchar *,int) noex ;
...
local int vecstr_load(vecstr *flp,cchar *dn,cchar *pre,int to) noex {

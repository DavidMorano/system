...
/*******************************************************************************
	...
	Synopsis:
	int uc_filetime(cchar *fname,CUTIMBUF *tbp) noex
	int uc_filetimes(cchar *fname,CTIMEVAL *tvp) noex
...
int uc_filetime(cchar *fname,CUTIMBUF *utp) noex {
	int		rs = SR_FAULT ;
	int		rs1 ;

...
int		varsub_expandbuf(VARSUB *,BUFFER *,cchar *,int) ;
...
static int	getkey(cchar *,int,int [][2]) ;
static int	ventcmp(cvoid **,cvoid **) ;
...
static int getkey(cchar *sp,int sl,int sses[][2])
{
	int		kl = -1 ;
...
static int ventcmp(cvoid **ve1pp,cvoid **ve2pp)
{

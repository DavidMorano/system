...
static int	subinfo_start(SUBINFO *,cchar *,cchar *,int) ;
...
static int	subinfo_makeconn(SUBINFO *,int,SOCKADDR *) ;
...
static int subinfo_makeconn(SUBINFO *sip,int pf,SOCKADDR *sap)
{

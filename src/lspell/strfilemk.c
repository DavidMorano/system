...
static int	strfilemk_objloadbegin(STRFILEMK *,cchar *,cchar *) ;
static int	strfilemk_objloadend(STRFILEMK *) ;
static int	strfilemk_loadcalls(STRFILEMK *,cchar *) ;

static int	isrequired(int) noex ;
...
static int isrequired(int i) noex {
{
	int	f = FALSE ;
	switch (i) {
	case sub_open:

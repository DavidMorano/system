...
#define	VARFILEROOT	"HELLO_FILEROOT"
#define	VARLOGTAB	"HELLO_LOGTAB"
...
#define	PIDFNAME	"run/hello"
#define	LOGFNAME	"var/log/hello"
#define	LOCKFNAME	"spool/locks/hello"

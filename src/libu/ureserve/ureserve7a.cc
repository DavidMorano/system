/* ureserve7a MODULE (implementation - field_prime) */
/* charset=ISO8859-1 */
/* lang=C++20 */
...
local constexpr fieldterminit		quotes("\"\'") ;
local constexpr fieldterminit		doubles("\"$\\`") ;
local constexpr fieldterminit		dterms("\r!#$%&,:;<=>") ;
local constexpr fieldterminit		shterms(" #") ;

local constexpr char	wterms[] = {
	0x00, 0x1A, 0x00, 0x00,
	0x3F, 0x40, 0x00, 0x7C,
	0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00,

...
#ifndef	UTYPEDEFSINTS_INCLUDE
#define	UTYPEDEFSINTS_INCLUDE
...
#include	<utypedefs_mints.h>	/* integers mutable */
#include	<utypedefs_cints.h>	/* integers constant */


#endif /* UTYPEDEFSINTS_INCLUDE */

...
#ifndef	USYSDEFSDATA_INCLUDE
#define	USYSDEFSDATA_INCLUDE
...
/* miscellaneious system (type) data */
#ifndef	UCHAR_BIT
#define	UCHAR_BIT	CHAR_BIT	/* unsigned is same as signed */
#endif


#endif /* USYSDEFSDATA_INCLUDE */

...
#if	CF_DEBUGS
	eprintf("main: about to open the KSTATs\n") ;
#endif
...
#if	CF_DEBUGS
	        eprintf("main: looping through names\n") ;
#endif
...
#if	CF_DEBUGS
	    eprintf("main: lookup 'system_misc' !\n") ;
#endif
...
#if	CF_DEBUGS
	        eprintf("main: got a 'system_misc'\n") ;
#endif
...
#if	CF_DEBUGS
	            eprintf("main: read some data, kid=%d\n",kid) ;
#endif

	            bprintf(ofp,"system_misc has %d records\n",
	                ksp->ks_ndata) ;

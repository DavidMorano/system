...
static int	msuclient_shmupdate(MSUCLIENT *) ;
static int	msuclient_shmchild(MSUCLIENT *) ;
...
static int msuclient_shmchild(MSUCLIENT *op)
{
	GETSYSMISC	kd ;
...
/* end subroutine (msuclient_shmchild) */

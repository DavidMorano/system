...
PROCDATA	*pdp ;
{
	...
	if (pdp->fl.plaintext && (aip->clines < 0)) {
...
/* write-back out the content-lines (if specified) */
	...
	if ((rs >= 0) && pdp->fl.plaintext && (aip->clines < 0)) {

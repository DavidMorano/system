...
#if	CF_DEBUGS
	debugprintf("kinfo_boottime: entered daytime=%s\n",
...
#if	CF_DEBUGS
	debugprintf("kinfo_loadave: entered daytime=%s\n",
	    timestr_log(ti_daytime,timebuf)) ;
#endif
...
#if	CF_DEBUGS
	debugprintf("kinfo_sysmisc: entered daytime=%s\n",
	    timestr_log(ti_daytime,timebuf)) ;
#endif
...
#if	CF_DEBUGS
	debugprintf("kinfo_check: entered daytime=%s\n",
	    timestr_log(ti_daytime,timebuf)) ;
#endif
...
#if	CF_DEBUGS
	debugprintf("kinfo_close: entered\n") ;
#endif

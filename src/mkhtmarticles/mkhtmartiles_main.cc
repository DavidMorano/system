...
extern int	proginfo_setpiv(PROGINFO *,cchar *,
			const struct pivars *) ;
extern int	progfile(PROGINFO *,struct artinfo *,cchar *) ;
...
local int	sfdigits(cchar *,int,cchar **) ;
local int	cmpfwd(cchar **,cchar **) ;
local int	cmprev(cchar **,cchar **) ;

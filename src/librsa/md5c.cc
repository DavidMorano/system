...
/**** Notes:
  ...
  1. This code has been prototyped up to conform with the current 
  C-language standard.
  2. This was slightly modied by:
  	= 2026-06-25, David A-D- Morano
...
#include	<cstdint>		/* CSTD fixed sized integers */
#include	<cstdio>		/* CSTD */

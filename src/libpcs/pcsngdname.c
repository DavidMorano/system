...
static int	mknewsdname(cchar *,char *,cchar *) ;
static int	mkdname(char *,int,cchar *,int) ;
static int	ndots(cchar *) ;
...
static int mknewsdname(cchar *pr,char *rbuf,cchar *newsdname)
{
	int	rs ;
	if (newsdname[0] != '/') {
...
static int mkdname(char *rbuf,int rlen,cchar *ngname,int mask)
{
	int	rs ;
	int	len = 0 ;

...
static void * sys_poll(void *ap)
{
	...
	for (;;) {
		...
		if (klogerrs >= 10) {
			logerror("can't rdebugopen kernel log device");
			exit(1);
		}
	}
	/*NOTREACHED*/

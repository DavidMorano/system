...
/* PCS facility open-service (pcsorg) */
...
#define	NDEBFNAME	"opensvc_pcsorg.deb"
...
#if	CF_DEBUGN
	nprintf(NDEBFNAME,"opensvc_pcsorg: 0 un=%s\n",un) ;
#endif

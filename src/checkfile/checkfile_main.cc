/* checkfile_main SUPPORT (File Checksum Program) */
/* charset=ISO8859-1 */
/* lang=C++20 */

/* program to perform a checksum on a file */
...
/*******************************************************************************
  	...
  	Description:
	This program performs a checksum on a file.
...
/* calculate the full path name to this file */
	...
	if (argv[1][0] != '/') {
	    ...
	    namelen = breadln(tfp,namebuf,MAXPATHLEN) - 1 ;

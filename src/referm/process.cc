...
static int	bufdesc_init(struct bufdesc *) ;
static int	bufdesc_add(struct bufdesc *,char *,int,int) ;
static int	bufdesc_free(struct bufdesc *) ;
...
static int bufdesc_add(bdp,buf,len,f_comma)
struct bufdesc	*bdp ;
char	buf[] ;
int	len, f_comma ;
{

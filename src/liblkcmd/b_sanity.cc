...
static constexpt char	blanks[NBLANKS+1] = "        " ;


/* exported subroutines */

int b_sanity(int argc,cchar *argv[],void *contextp) noex {
	int		rs ;
	int		rs1 ;
	int		ex = EX_OK ;
...
int p_sanity(int argc,cchar *argv[],cchar *envv[],void *contextp) noex {

/* b_mailexpire SUPPORT (KSH builtin) */
/* charset=ISO8859-1 */
	        ...
	        while ((kl = keyopt_curenumkeys(kop,&kcur,&kp)) >= 0) {
	            ...
	            if ((oi = matostr(akonames,2,kp,kl)) >= 0) {
	                ...
	                case akoname_allusers:
	                    if (! lip->finval.allusers) {
	                        lip->finval.allusers = TRUE ;

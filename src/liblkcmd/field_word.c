...
/* revision history:
	...
	= 2002-05-01, David A­D­ Morano
        This was created (from 'field_get()') to deal with parsing keys that are
        supposed to be English words in prose.
...
/*******************************************************************************
        ...
        This subroutine finds the next "word" in the buffer. This is different
        than 'field_get()' since no default quoting is assumed.

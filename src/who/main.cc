 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)who.c	1.22	99/10/04 SMI"	/* SVr4.0 1.23	*/
...
static void ck_file(const char *);
...
static const char	*program;	/* holds name of this program	*/
#ifdef	XPG4
...
static void ck_file(const char *name)
{
	struct	stat sbuf;
	int	rc;

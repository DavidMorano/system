...
*_switch_gethostbyname_r(const char *, struct hostent *,
    char *, int, int *);
extern struct hostent	
*_switch_gethostbyaddr_r(const char *, int, int,
    struct hostent *, char *, int, int *);
extern struct hostent	
*_switch_getipnodebyname_r(const char *,
    struct hostent *, char *, int, int, int, int *);
extern struct hostent	
*_switch_getipnodebyaddr_r(const char *, int, int,
    struct hostent *, char *, int, int *);
extern struct hostent	
*_door_gethostbyname_r(const char *, struct hostent *,
    char *, int, int *);
extern struct hostent	
*_door_gethostbyaddr_r(const char *, int, int,
    struct hostent *, char *, int, int *);
extern struct hostent	
*_door_getipnodebyname_r(const char *, struct hostent *,
    char *, int, int, int, int *);
extern struct hostent	
*_door_getipnodebyaddr_r(const char *, int, int,
    struct hostent *, char *, int, int *);
